# Functional Source License, Version 1.1, AGPL 3.0 Future License
...
the GNU Affero General Public License, version 3, that is effective on the first
anniversary of the date we make the Software available. On or after that date,
you may use the Software under the GNU Affero General Public License, version 3,
