...
async function run() {
  ...
  const migrationPath = path.resolve(process.cwd(), 'drizzle/0022_stripe_webhook_endpoints.sql');
  ...
  console.log(`Running ${statements.length} statements from 0022_stripe_webhook_endpoints.sql...`);
