...
export function Anthropic(props: SvgProps) {
  return (
    <svg
      overflow="visible"
      width="100%"
    ...
    >
      <path
        ...
        style={{
          ...
          transform: "rotate(330deg) scaleY(1.20792) rotate(-330deg)",
        }}
      />
      <path
        ...
        style={{
          transformOrigin: "50px 50px",
          transform: "rotate(300deg) scaleY(1.06625) rotate(-300deg)",
        }}
      />
      <path
        ...
        style={{
          transformOrigin: "50px 50px",
          transform: "rotate(270deg) scaleY(1.01459) rotate(-270deg)",
        }}
      />
      <path
        ...
        style={{
          transformOrigin: "50px 50px",
          transform: "rotate(240deg) scaleY(0.997) rotate(-240deg)",
        }}
      />
      <path
        ...
        style={{
          transformOrigin: "50px 50px",
          transform: "rotate(210deg) scaleY(1.09) rotate(-210deg)",
        }}
      />
      <path
        ...
        style={{
          transformOrigin: "50px 50px",
          transform: "rotate(180deg) scaleY(1.075) rotate(-180deg)",
        }}
      />
      <path
        ...
        style={{
          transformOrigin: "50px 50px",
          transform: "rotate(150deg) scaleY(1.06) rotate(-150deg)",
        }}
      />
      <path
        ...
        style={{
          transformOrigin: "50px 50px",
          transform: "rotate(120deg) scaleY(0.94) rotate(-120deg)",
        }}
      />
      <path
        ...
        style={{
          transformOrigin: "50px 50px",
          transform: "rotate(90deg) scaleY(1.03) rotate(-90deg)",
        }}
      />
      <path
        ...
        style={{
          transformOrigin: "50px 50px",
          transform: "rotate(60deg) scaleY(0.992081) rotate(-60deg)",
        }}
      />
      <path
        ...
        style={{
          transformOrigin: "50px 50px",
          transform: "rotate(30deg) scaleY(1.02875) rotate(-30deg)",
        }}
      />
      <path
        ...
        style={{
          transformOrigin: "50px 50px",
          transform: "rotate(0deg) scaleY(1.18541) rotate(0deg)",
        }}
      />
    </svg>
  );
